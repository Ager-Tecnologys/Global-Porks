...
>>>>>>> 3163c33a6fc261477b0d506efb5e0cdb54e2ffad
...
function cadastrarVinculo(idUsuario, fkEmpresa, fkArea) {
  console.log("Entrando na Model.");
  console.log(
    "ACESSEI A EMPRESA MODEL \n \n\t\t >> Se aqui der erro de 'Error: connect ECONNREFUSED',\n \t\t >> verifique suas credenciais de acesso ao banco\n \t\t >> e se o servidor de seu BD está rodando corretamente. \n\n function cadastrar():",
    idUsuario,
  ...
  var instrucao = `insert into [dbo].[vinculo] (fkUsuario, areaFkEmpresa, fkArea) values
    ('${idUsuario}', '${fkEmpresa}', ${fkArea});`;
  console.log("Executando a instrução SQL: \n" + instrucao);
  return database.executar(instrucao);
}

function buscarUltimaArea() {

    instrucaoSql = `select top 1 idArea from [dbo].[areas] order by idArea desc;`
